...
CFLAGS			=	-Wall -Wextra -Werror -g3# -Wall -Werror -Wextra
...
SRCS_NAMES		=	main.c game/keysandpars.c game/texture.c game/initialisation.c game/initialisationbis.c \
					...
					parsing/parsing.c parsing/parsing2.c parsing/utils.c  parsing/copy_double_tab.c parsing/checking.c parsing/free_checking.c parsing/check_colors.c\
